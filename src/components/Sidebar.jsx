    ...
    return (
        <div className="w-[25%] h-full p-2 flex-col gap-2 text-white lg:flex">
            <div className="bg-[#121212] h-[15%] rounded flex flex-col justify-around ">
                <div  onClick={()=>navigate('/')} className="flex items-center gap-3 pl-8 cursor-default">
                    <img className="w-6" src={assets.home_icon} alt="Home Icon" />
                    <p className="font-bold cursor-pointer">Home</p>
                </div>
                <div className="flex items-center gap-3 pl-8 cursor-default">
            ...
            <div className='bg-[#121212] h-[85%] rounded'>
                ...
                <div className='p-4 bg-[#242424]  m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4'>
                    <h1 className='text-[20px]'>Create Your first playlist</h1>
                    <p className='font-light'>It's easy, we will help you</p>
                    <button className='px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4'> Create Playlist </button>
                </div>
                <div className='p-4 bg-[#242424]  m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4'>
                    <h1 className='text-[20px]'>Let's find some podcasts to follow</h1>
